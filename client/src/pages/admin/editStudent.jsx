...
import { getStudentDetails, updateStudent } from '../../redux/actions/studentAction';
...
export default function EditStudent() {
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(updateStudent({ studentId: id, data: studentData })).then(() => {
    ...
    <Container component="main" maxWidth="xs">
      ...
      >
        ...
        <Box component="form" onSubmit={handleSubmit} sx={{ mt: 3 }}>
          ...
          >
            {isLoading ? <CircularProgress /> : "Update Student details"}
          </Button>
        </Box>
      </Box>
    </Container>
